...
public class SocialNetwork {
	...
	public static void main (String args[]) {
		...
		SocialNetwork contacts = new SocialNetwork(); {
			...
			contacts.add("Hasan", "Ahmed", "hasan@uwo.ca");
			contacts.add("Jake", "Jones", "jake@ubc.ca");
			contacts.add("Tom", "Delit", "tom@queens.ca");
			
			System.out.println(contacts.toString());
			System.out.println("I have " + contacts.getNumFriends() + " friends in my contact list.");
			
			contacts.clearFriends();
			System.out.println("I cleared the friends, now I have " +contacts.getNumFriends() +" friends!");
		}
	}
